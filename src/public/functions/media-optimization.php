...
class ThemeMediaOptimization
{
  ...
  public static function init(): void
  {
    ...
    add_filter(
      ...
      [self::class, 'add_safe_lazy_loading'],
      10,
      3,
    );
    ...
    add_filter(
      'sanitize_file_name',
      [self::class, 'safe_optimize_filename'],
      10,
    );
   ...
   */
  public static function add_safe_lazy_loading(
    array $attr,
    WP_Post $attachment = null,
    string $size = '',
  ): array {
  ...
  public static function convert_to_webp(array $upload): array
  {
    ...
    try {
      ...
      $webp_path =
        $path_info['dirname'] . '/' . $path_info['filename'] . '.webp';
    ...
    if (isset($metadata['sizes'])) {
      foreach ($metadata['sizes'] as $size_name => $size_data) {
        ...
        if (
          ...
          strpos($size_data['mime-type'], 'image/webp') === 0
        ) {
          try {
