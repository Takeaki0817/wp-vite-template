...
class ThemeSetup
{
  ...
  public static function init(): void
  {
    ...
    add_filter(
      'script_loader_tag',
      [self::class, 'add_defer_attribute'],
      10,
      2,
    );
  }
  ...
  public static function enqueue_assets(): void
  {
    ...
    // 追加スタイル
    if (
      file_exists(get_template_directory() . '/assets/styles/add-style.css')
    ) {
      wp_enqueue_style(
        'theme-add-style',
   ...
   */
  private static function enqueue_page_specific_scripts(
   ...
   */
  public static function add_defer_attribute(
    string $tag,
    string $handle,
  ): string {
